...
public class defusethelogic {
	...
	public static void main(String[] args) {
		...
		for(int i=2;i<1000001;i++)
			coprime[i] = ((coprime[i]*i)/2)%mod;
		for(int i=0;i<n;i++) {
			int age = ir.nextInt();
			sum = (sum%mod + coprime[age]%mod)%mod;
		}
		...
		if(ar.size()%2==0)
			pw.println("Coder can save the world!");
		else
			pw.println("Boom!");
